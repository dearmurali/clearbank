clearbank = angular.module('ClearBank', ['ngRoute','ngMessages','ui.router','pascalprecht.translate', 'ngSanitize']);
...
clearbank.controller("forgotPasswordController",['$scope', 'ForgotPasswordService', function($scope, ForgotPasswordService){

	//function to confirm change password submission
	$scope.forgotPasswordWidget=true;
	$scope.isValidMobileNumber=false;
	
	$scope.checkMobileNumber=function(mobile_number){
		console.log('checkMobileNumber ',mobile_number);
		ForgotPasswordService.validateMobileNumber(mobile_number, function(result){
			console.log(result);
			$scope.isValidMobileNumber=result.data.success;
			console.log('$scope.isValidMobileNumber ' ,$scope.isValidMobileNumber);
		})
	}
...
clearbank.controller('registrationController',['$scope', 'RegistrationService', function($scope, RegistrationService){
	var isValid=true;
