...
//    if(self.accountInfo[i].account_type=="Saving")
//        {
//            self.debitAccount=self.accountInfo[i].account_number;
//            self.available_balance=self.accountInfo[i].available_balance;
//            self.currency=self.accountInfo[i].currency;
//            
//            self.transferAccount.push({ account_number:$ctrl.accountInfo[i].account_number,
...
//        }
//    if(self.accountInfo[i].account_type=="Current")
//        {
//            self.transferAccount.push({ account_number:self.accountInfo[i].account_number,
//                                 account_type:self.accountInfo[i].account_type,
//                                 available_balance:self.accountInfo[i].available_balance,
//                                 currency:self.accountInfo[i].currency});
//        }  
